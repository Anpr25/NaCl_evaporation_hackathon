...
def apply_declared_fallbacks(
    ...
    """Add a fallback beside every specified guard that was proved unreachable.

    Returns the transitions added, empty when there was nothing to do -- which is the signal
    the pipeline uses to decide whether a second simulation pass is worth running.
    """
